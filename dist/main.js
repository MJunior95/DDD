...
let customer = new customer_1.default("123", "Michel Junior");
const address = new address_1.default("Estrada das Pitas", 213, "06499-323", "São Paulo");
customer.Address = address;
customer.activate();
const item1 = new order_item_1.default("1", "Item 1", 10);
const item2 = new order_item_1.default("2", "Item 2", 14);
